...
func TestParseReqParam(t *testing.T) {
	...
	clearFlags()
	pkgMap = make(map[string]string)
	expected = map[string]string{"google/api/annotations.proto": "github.com/jackami/grpc-gateway/third_party/googleapis/google/api"}
	err = parseReqParam("allow_delete_body,allow_merge,file=./foo.pb,import_prefix=/bar/baz,Mgoogle/api/annotations.proto=github.com/jackami/grpc-gateway/third_party/googleapis/google/api", f, pkgMap)
	if err != nil {
	...
	pkgMap = make(map[string]string)
	expected = map[string]string{"google/api/annotations.proto": "github.com/jackami/grpc-gateway/third_party/googleapis/google/api"}
	err = parseReqParam("allow_delete_body=true,allow_merge=true,merge_file_name=test_name,file=./foo.pb,import_prefix=/bar/baz,Mgoogle/api/annotations.proto=github.com/jackami/grpc-gateway/third_party/googleapis/google/api", f, pkgMap)
	if err != nil {
