...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/jackami/grpc-gateway/examples/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/jackami/grpc-gateway/examples/cmd/example-gateway-server',
]));
