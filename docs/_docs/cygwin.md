...
Then `go get -u -v` the following packages:
    ...
    go get -u -v github.com/jackami/grpc-gateway/protoc-gen-grpc-gateway
    go get -u -v github.com/jackami/grpc-gateway/protoc-gen-swagger
    go get -u -v github.com/golang/protobuf/protoc-gen-go

This will probably fail with similar output.

    github.com/jackami/grpc-gateway (download)
    # cd .; git clone https://github.com/jackami/grpc-gateway C:\path\to\your\cygwin\home\user\go\src\github.com\jackami\grpc-gateway
    Cloning into 'C:\path\to\your\cygwin\home\user\go\src\github.com\jackami\grpc-gateway'...
    fatal: Invalid path '/home/user/go/C:\path\to\your\cygwin\home\user\go\src\github.com\jackami\grpc-gateway': No such file or directory
    package github.com/jackami/grpc-gateway/protoc-gen-grpc-gateway: exit status 128
...
Copy and paste these lines into your shell and change the clone destination directories.
    ...
    git clone https://github.com/jackami/grpc-gateway $(cygpath -u $GOPATH)/src/github.com/jackami/grpc-gateway
...
## Usage
Follow the [instuctions](https://github.com/jackami/grpc-gateway#usage) in the [README](https://github.com/jackami/grpc-gateway).

Adjust steps 3, 5 and 7 like this. protoc expects native windows paths.

    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/jackami/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:. ./path/to/your_service.proto
    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/jackami/grpc-gateway/third_party/googleapis --grpc-gateway_out=logtostderr=true:. ./path/to/your_service.proto
    protoc -I. -I$(cygpath -w /usr/local/include) -I${GOPATH}/src -I${GOPATH}/src/github.com/jackami/grpc-gateway/third_party/googleapis --swagger_out=logtostderr=true:. ./path/to/your_service.proto
